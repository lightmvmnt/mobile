...
const TabBarComponent: React.FC<BottomTabBarProps> = ({state, descriptors, navigation}) => {
    ...
    const getRouteName = () => {
        ...
        if (!routesObject?.state) return routesObject?.name;
    ...
    const isTasksActive = routeName === 'TasksScreen' || routeName === 'TaskDetailScreen';
    const isPollsActive = routeName === 'PollsScreen' || routeName === 'PollDetailsScreen';
